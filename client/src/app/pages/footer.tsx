...
function Footer() {
  return (
    <footer className="main  py-8 z-50  bg-[#090e23] ">
      <ul
        data-aos="fade-down"
        className="flex item-center justify-center gap-6 mb-8"
      >
        <li className="m-0">
          <a
            title="View my GitHub profile"
            aria-label="See my GitHub profile"
            href="https://github.com/Ajitesh72"
            target="_blank"
            className="nav-text p-1"
          >
        ...
        <li className="m-0">
          <a
            ...
            href="https://www.linkedin.com/in/ajitesh-dubey-4b5852220/"
            target="_blank"
            className="nav-text p-1"
          >
        ...
        <li className="m-0">
          <a
            ...
            href="https://www.instagram.com/ajitesh._/"
            target="_blank"
            className="nav-text p-1"
          >
      ...
      <div className="text-center">
        <a
          data-aos="fade-up"
          className="nav-text text-gray-700 dark:text-gray-50"
          href="https://github.com/Ajitesh72"
          target="_blank"
        >
